                ...
                if( $con )
                {
                  ...
                  ?>
                    <tr class="gradeX">
                      ...
                      <td class="center">
                        <a href="#" class="fa fa-pencil-square-o" aria-hidden="true" onclick="modificarUsuario('<?= $row["id_usuarios"] ?>','<?= utf8_encode( $row["usuario"] ) ?>',
                          '<?= $row["password"] ?>','<?= utf8_encode( $row["id_perfil"] ) ?>')"></a>
                      </td>
                      <td class="center">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel"> <i class="fa fa-users fa-fw"></i> Usuarios</h4>
        </div>
                    ...
                    <div class="col-lg-12">
                      <form id="form_nuevo_usuario" role="form">
                        <div class="row form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="new_nombre" name="new_nombre" class="form-control" placeholder="Nombre usuario">
                        ...
                        <div class="row form-group">
                          ...
                          <div class="col-sm-9">
                            <select id="new_perfil" name="new_perfil">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <form id="form_editar_usuario" role="form">
                        ...
                        <div class="row form-group">
                          <label class="col-sm-3" for="edit_nombre">Usuario:</label>
                          <div class="col-sm-9">
                            <input type="text" id="edit_nombre" name="edit_nombre" class="form-control" placeholder="Nombre Usuario">
                            <div id="msg_error_nombre" class="alert alert-danger" role="alert">Campo requerido</div>
                          </div>
                        </div>
                        <div class="row form-group">
